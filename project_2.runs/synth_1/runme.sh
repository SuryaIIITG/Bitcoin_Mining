...
HD_PWD='C:/Users/surya/Desktop/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitcoin_miner.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitcoin_miner.tcl
